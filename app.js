...
console.log('new sum using arrow function '+newSum(5, 2, 3, 4));
...
console.log('new object using arrow function',newObjectLit());
...
console.log('new sum and product using arrow function',newSumAndProduct(1, 9));
...
console.log('new meg using arrow function\n',newMessage('Allie'));
...
// using arrow function
let ali = new Student('ali', 'Schmoe', 100);
...
// also undifined but 227 print a window
// 3. Explain why "this" is different when an arrow function is used.
// arrow functions return this value of the enclosing functional scope.
